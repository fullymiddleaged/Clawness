 ...
 */
const queryCommand: ClawnessCommand = {
  name: "clawness-query",
  description: "Show which Clawness rules retrieve for a given prompt.",
  acceptsArgs: true,
  async run(args: string): Promise<CommandOutput> {
 ...
 */
const auditRulesCommand: ClawnessCommand = {
...
export const CLAWNESS_COMMANDS: readonly ClawnessCommand[] = [
  statusCommand,
  queryCommand,
  auditRulesCommand,
];
